...
<section style="background:var(--color-bg);padding:clamp(34px,5vw,84px) 0 clamp(46px,6.5vw,104px)">
  <div style="max-width:1560px;margin:0 auto;padding:0 clamp(18px,3.4vw,56px);display:grid;grid-template-columns:minmax(210px,250px) minmax(0,1fr);gap:clamp(26px,3.4vw,64px);align-items:start">
